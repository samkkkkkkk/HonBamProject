...
import '@/Component/Board/ProfileEdit.css';
    ...
    <div className="ProfileEdit">
      <div className="div">
        ...
        <div className="overlap-group">
          ...
          <img className="img" alt="Vector" src="vector-5.png" />
          <div className="email">
          ...
          <Grid item xs={12}>
            ...
            >
              <img src={imgFile || bambam} alt="profile" />
            </div>
          ...
          <div className="id">
            ...
            <div className="back">
              <Link to="/Setting">
                <button type="button" className="backBtn"></button>
              </Link>
            </div>
          </div>
        </div>
