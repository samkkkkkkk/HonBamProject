...
import '@/Component/Inquiry/modify/InquiryModify.css';
      ...
      <div className="inquiry_modify">
        ...
        <div className="grid-2">
          {getLoginUserInfo().userId === WriterId ? (
            <Button className="inquiry_modify_save_button" onClick={formSave}>
              저장
            </Button>
          ) : (
            ''
          ...
          <Button className="inquiry_modify_cancel_button" onClick={formCancel}>
            취소
          </Button>
          <Button className="inquiry_modify_delete_button" onClick={formDelete}>
            삭제
          </Button>
        </div>
      </div>
