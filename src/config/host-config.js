...
export const AUTH = import.meta.env.VITE_AUTH || 'api/auth';
export const USER = import.meta.env.VITE_USER || '/api/users';
...
export const UPLOAD = import.meta.env.VITE_UPLOAD || '/api/upload';
